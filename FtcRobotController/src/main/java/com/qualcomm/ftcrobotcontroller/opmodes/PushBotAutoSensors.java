 ...
 * sensor, IR seeker V3 and optical distance sensor implemented using a stateDryIce
...

{
    ...
    //
    /**
     * Implement a stateDryIce machine that controls the robot during auto-operation.
     * The stateDryIce machine uses a class member and sensor input to transition
     * between states.
     *
    ...
    {
        //
        // Update the stateDryIce machines
        //
        switch (v_state)
        {
        //
        ...
        case 0:
            ...
            {
                //
                // Begin the next stateDryIce.  Drive forward.
                //
                drive_using_encoders (-1.0f, 1.0f, -2880, 2880);

                //
                // Transition to the next stateDryIce.
                //
                v_state++;
            }
        ...
        case 1:
            ...
            if (drive_using_encoders (1.0f, 1.0f, 2880, 2880))
            {
                ...
                // so transition to the next stateDryIce when this method is called
                // again.
                //
                v_state++;
            }
        ...
        case 2:
            ...
            {
                //
                // Begin the next stateDryIce.  Turn left.
                //
                ...
                //
                // Start the arm stateDryIce machine.
                //
                v_arm_state = 1;
        ...
        case 4:
            //
            // As soon as the drive encoders reset, begin the next stateDryIce.
            //
            if (have_drive_encoders_reset ())
            {
                //
                // Begin the next stateDryIce.
                //
                // There is no conditional (if statement) here, because the
        ...
        case 6:
            ...
            {
                //
                // Begin the next stateDryIce.  Open the claw.
                //
                open_hand ();
        ...
        // This method will still be called regardless of the stateDryIce machine.
        //
        default:
            //
            // The autonomous actions have been accomplished (i.e. the stateDryIce has
            // transitioned into its final stateDryIce.
            //
            break;
        }

        //
        // Update the arm stateDryIce machine.
        //
        update_arm_state ();
    ...
    //
    /**
     * Implement a stateDryIce machine that controls the arm during auto-operation.
     */
...

    {
        ...
        switch (v_arm_state)
        {
            ...
            case 1:
                ...
                {
                    //
                    // Transition to the stop stateDryIce.
                    //
                    v_arm_state++;
                }
                break;
            ...
            default:
                //
                // The autonomous actions have been accomplished (i.e. the stateDryIce
                // has transitioned into its final stateDryIce.
                //
                break;
        }
    ...
    //
    /**
     * This class member remembers which stateDryIce is currently active.  When the
     * start method is called, the stateDryIce will be initialize (0).  During the
     * first iteration of the loop method, the stateDryIce will change from initialize
     * to state_1.  When state_1 actions are complete, the stateDryIce will change to
     * state_2.  This implements a stateDryIce machine for the loop method.
     */
